/* ═══════════════════════════════════════════════
   ATUM Torus Field — Canvas Particle Animation
   ═══════════════════════════════════════════════ */

window.TorusField = class TorusField {
  constructor(canvas, opts = {}) {
    ...
    this.ambientCount = opts.ambientCount || 60;
    this.speed = opts.speed || 1;
    this.tiltX = opts.tiltX || 0.45;
    this.tiltZ = opts.tiltZ || 0.15;
    this.fov = opts.fov || 600;
    this.glowIntensity = opts.glowIntensity || 1;
    this.running = true;
    this._raf = null;

    this.colors = [
      { r: 34, g: 197, b: 94 },   // ATUM green
      { r: 239, g: 68, b: 68 },   // BULL red
      { r: 59, g: 130, b: 246 },  // TOR blue
    ];
  ...
  setGlow(g) { this.glowIntensity = g; }
