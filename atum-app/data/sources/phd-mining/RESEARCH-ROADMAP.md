...
**المصادر:** mesurable-ideas.md + INSPIRATION-SYNTHESIS.md + data paper
**المصادر الجديدة:** 7 مجلدات NotebookLM (القبيسي، داود، كون، مصادر أخرى، توفيق المثقفات، تينين، بروفوست)
...
### 🔄 الأفكار المكررة في mesurable-ideas.md (تم دمجها)
...
| 🥉 | **Lexical Borrowing Statistics** — العربية ثالث مصدر للدخيل الفرنسي | بروفوست (جديد) | ⭐⭐⭐ | ⭐⭐⭐⭐ (قواميس رقمية + إحصائيات) | 1 مصدر |
| 🥉 | **Arabic Etymology of Risk (Rizq)** — Risk من رزق (وثائق طليطلة 13م) | بروفوست (جديد) | ⭐⭐⭐ | ⭐⭐⭐ (تأثيل تاريخي) | 1 مصدر |
| 🥉 | **"al-" Article Fossilization** — أل التعريف تتحجر في A- الرومانسية | بروفوست (جديد) | ⭐⭐⭐ | ⭐⭐⭐ (تحليل صرفي عبر-لغوي) | 1 مصدر |
...
| **جديد:** أسطورة قهوة كالدي والعنزات (Kaldi Coffee) | أسطورة شعبية لا دليل تاريخياً عليه | بروفوست |
| **جديد:** نقاء العربية المطلق (Purity of Arabic) | ادعاء أيديولوجي — كل اللغات تتطور وتستعير | بروفوست |
| **جديد:** العجم → كهرباء (al-ajam → electricity) | تأثيل غير موثق في المعاجم الأكاديمية | بروفوست |
...
*تم الإعداد: 2026-06-09 | التحديث الثالث: 2026-06-10*
*بعد قراءة وتحليل mesurable-ideas.md (7 أقسام) + INSPIRATION-SYNTHESIS.md (15 مصدراً) + 7 مجلدات NotebookLM جديدة (القبيسي، داود، كون، مصادر أخرى، توفيق المثقفات، تينين، بروفوست)*
